...
export default function PaymentScreen({ route }: { route: any }): React.JSX.Element {
  const navigation = useNavigation();
  const { user } = useAuth();
  const { meal, nbPeople, total }: { meal: Meal; nbPeople: number, total: number } = route.params;
        ...
        <SafeAreaView>
          ...
          <View style={{ padding: 24 }}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 24 }}>
              ...
              <Text style={{ fontSize: 26, fontWeight: "bold" }}>Payez votre Kajou !</Text>
            </View>
